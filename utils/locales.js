export default {
  'zh_cn': {
    ...
    'options': {
      ...
      'options10': '不处理',
      'options11': '只是语音报警',
      'options12': '语音报警并依据防夹是否有信号来确定是否关门',
      'options13': '满足菜单3的条件关门后，如反向进入信号撤除就再开门',
      'options14': '反向进入语音报警并强制关门，不检测防夹信号',
      'options45': '满足菜单3的条件关门后，如反向进入信号撤除就再开门',
      'options15': '只是语音报警',
      'options16': '只要防夹信号没人就立即关门',
      'options17': '立即关门，不考虑防夹信号',
      'options18': '中间一对防夹',
      'options19': '通行方向的前2对防夹',
      'options20': '左红外开门',
      'options21': '右红外开门',
      'options22': '中文',
      'options23': '英文',
  ...
  'en': {
    ...
    'options': {
      ...
      'options45': 'Close the door immediately without considering the anti-pinch signal',
