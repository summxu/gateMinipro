...
App({
  ...
  getContentToJson () {
    ...
    var tempJson = {
      ...
      F1: Number('0x' + arr[1]), // “延时开闸时间” ，取值范围0~5 
      F2: Number('0x' + arr[2]), // “延时关闸时间” ，取值范围0~5
      ...
      E0: Number(String(arr[20]).substring('')[1]) || 1,  // 关门模式 拆分20字节的高半字节
      ...
      E7: Number(String(arr[20]).substring('')[0]) || 1,  // “断电开闸设置” 拆分20字节的低半字节 
